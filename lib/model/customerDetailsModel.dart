...
class CustomerDetailsModel {
    ...
    static List<CustomerDetailsModel> fromList(List<Map<String, dynamic>> list) {
        return list.map(CustomerDetailsModel.fromJson).toList();
    }
